...
FROM (VALUES
    ...
    (N'2111', N'Federal Income Tax Withheld Payable', N'Liability', N'Current Liabilities'),
    (N'2112', N'State Income Tax Withheld Payable', N'Liability', N'Current Liabilities'),
    (N'2113', N'Local Tax Withheld Payable', N'Liability', N'Current Liabilities'),
    (N'2114', N'Employee Social Security Payable', N'Liability', N'Current Liabilities'),
    (N'2115', N'Employee Medicare Payable', N'Liability', N'Current Liabilities'),
    (N'2116', N'Employer Payroll Taxes Payable', N'Liability', N'Current Liabilities'),
    (N'2117', N'Pre-Tax Deductions Payable', N'Liability', N'Current Liabilities'),
    (N'2118', N'Retirement Contributions Payable', N'Liability', N'Current Liabilities'),
    (N'2119', N'Post-Tax Deductions Payable', N'Liability', N'Current Liabilities'),
    (N'2120', N'Accrued Expenses', N'Liability', N'Current Liabilities'),
    (N'2121', N'Garnishments Payable', N'Liability', N'Current Liabilities'),
    ...
    (N'6220', N'Employer Payroll Taxes Expense', N'Expense', N'Operating Expenses'),
