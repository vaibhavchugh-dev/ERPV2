    ...
    public class AttendanceController : ApiBaseController
    {
        ...
        public async Task<IActionResult> GetPunchBoard()
        {
            ...
            var users = employees.Select(u =>
            {
                ...
                return new
                {
                    ...
                    todayPunchIn = lastIn != null ? DateTime.SpecifyKind(lastIn.PunchTime, DateTimeKind.Utc) : (DateTime?)null,
                    todayPunchOut = lastOut != null ? DateTime.SpecifyKind(lastOut.PunchTime, DateTimeKind.Utc) : (DateTime?)null,
                    todayBreakOut = lastBreakOut != null ? DateTime.SpecifyKind(lastBreakOut.PunchTime, DateTimeKind.Utc) : (DateTime?)null,
            ...
            foreach (var employee in employees)
            {
                ...
                for (var day = fromLocal; day <= toLocal; day = day.AddDays(1))
                {
                    ...
                    rows.Add(new
                    {
                        ...
                        punchIn = firstIn != null ? DateTime.SpecifyKind(firstIn.PunchTime, DateTimeKind.Utc) : (DateTime?)null,
                        punchOut = lastOut != null ? DateTime.SpecifyKind(lastOut.PunchTime, DateTimeKind.Utc) : (DateTime?)null,
                        hours,
                        status,
            ...
            [FromQuery] bool includeFailed = false)
        {
            ...
            var rows = logs.Select(p =>
            {
                ...
                {
                    id = p.Id,
                    punchTime = DateTime.SpecifyKind(p.PunchTime, DateTimeKind.Utc),
