    ...
    try {
      ...
      if (vendor) {
        ...
        const vendorData: VendorMasterReq = {
          ...
          City: (vendor as any).city || vendor.City || "",
          states: (vendor as any).states || vendor.states || "",
          zipcode: (vendor as any).zipcode || vendor.zipcode || "",
          country: (vendor as any).country || vendor.country || "US",
          shippingaddress: (vendor as any).shippingaddress || vendor.shippingaddress || "",
          shippingCity: (vendor as any).shippingCity || vendor.shippingCity || "",
          shippingStates: (vendor as any).shippingStates || vendor.shippingStates || "",
          shippingCountry: (vendor as any).shippingCountry || vendor.shippingCountry || "US",
          shippingZipCode: (vendor as any).shippingZipCode || vendor.shippingZipCode || "",
          shippingApartment: (vendor as any).shippingApartment || vendor.shippingApartment || "",
        ...
        try {
          ...
          const message = String(
            portalError?.response?.data?.error ||
              portalError?.response?.data?.message ||
              portalError?.message ||
              ""
          );
